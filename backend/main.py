...
@app.get("/transcripts")
async def get_transcripts(skip: int = 0, limit: int = 20):
    """Get list of transcripts"""
    # Mock data - replace dengan DB query
    return {
        "items": [
            {
                "id": 1,
                ...
                "language": "id",
                "segments": [],
                "full_text": "Mock transcript data"
            }
        ],
        "total": 1
    }
...
async def get_latest_transcript():
    ...
    # Mock data - replace dengan DB query untuk ambil transcript terbaru
    return {
        "id": 1,
        "status": "DONE",
        "language": "id",
...
@app.get("/transcripts/{transcript_id}/status")
async def get_transcript_status(transcript_id: int):
