...
import type { ChartConfig } from '@/transcript/components/ui/chart'
...
import {
  ...
  ChartTooltipContent,
  componentToString,
} from '@/transcript/components/ui/chart'
import {
  Select,
  SelectContent,
  SelectItem,
...
<template>
  <Card class="pt-0">
    <CardHeader class="flex items-center gap-2 py-5 space-y-0 border-b sm:flex-row">
