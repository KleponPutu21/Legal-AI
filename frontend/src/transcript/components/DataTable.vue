...
import { Checkbox } from '@/transcript/components/ui/checkbox'
import {
  DropdownMenu,
  ...
  DropdownMenuTrigger,
} from '@/transcript/components/ui/dropdown-menu'

import { Label } from '@/transcript/components/ui/label'
import {
  Select,
  SelectContent,
  SelectItem,
...
import {
  ...
  TableHeader,
  TableRow,
} from '@/transcript/components/ui/table'
...
// import { DragDropProvider } from "dnd-kit-vue"
// import { restrictToVerticalAxis } from "@dnd-kit-vue/modifiers"
...
const columns: ColumnDef<TableData>[] = [
  ...
  },
  {
    ...
    header: "Name",
    cell: ({ row }) => {
      const onHeaderClick = row.original.onHeaderClick
      return h(Button, {
        variant: "link",
        size: "sm",
        class: "h-auto p-0 text-sm font-medium hover:underline cursor-pointer",
...
<template>
  <Tabs
    ...
    class="flex-col justify-start w-full gap-6"
  >
    ...
    <TabsContent
      value="outline"
      class="relative flex flex-col gap-4 px-4 overflow-auto lg:px-6"
    >
      ...
      <div class="flex items-center justify-between px-4">
        <div class="flex-1 hidden text-sm text-muted-foreground lg:flex">
          {{ table.getFilteredSelectedRowModel().rows.length }} of
          {{ table.getFilteredRowModel().rows.length }} row(s) selected.
        </div>
        <div class="flex items-center w-full gap-8 lg:w-fit">
          ...
          <div class="flex items-center justify-center text-sm font-medium w-fit">
    ...
    >
      <div class="flex-1 w-full border border-dashed rounded-lg aspect-video" />
    </TabsContent>
