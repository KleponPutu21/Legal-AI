...
class HttpClient {
    ...
    constructor(baseURL: string = 'https://able-estimate-towers-tide.trycloudflare.com') {
...
export const http = new HttpClient('https://able-estimate-towers-tide.trycloudflare.com/');
